    ...
    return (
        <div className="onlineExpiriences">
            ...
            <div className="left">
                ...
                <p className="paragraphs">Dzień z życia tancerki w Las Vegas</p>
            </div>
            <div className="topRightbox1">
                ...
                <div><p className="paragraphs">Rozkoszuj się wieczorem pełnym muzyki i dobrych fluidów</p></div>
            </div>
            <div className="topRightbox2">
                ...
                <div><p className="paragraphs">Noc magii i czytania w myślach</p></div>
            </div>
            <div className="bottomRight">
                <img src="https://a0.muscache.com/im/pictures/d88db0e7-ef5b-49c6-ae07-af3525ac252f.jpg?im_w=1200" alt="" />
                <p className="paragraphs">Weż udział w musicalu na żywo</p>
            </div>
